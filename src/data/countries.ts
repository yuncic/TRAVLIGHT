...
export const COUNTRIES: Country[] = [
  {
    ...
    "customs": {
      "warning": "육류·육가공품(햄·소시지·육포·만두 등)은 동물검역 대상으로, 소량이라도 반입 시 최대 벌금·징역 및 압수 대상입니다. 공항에서 구입한 것도 예외가 아닙니다.",
      "banned": [
  ...
  },
  {
    ...
    "customs": {
      "warning": "육류 성분이 미량이라도 포함된 가공식품(예: 소고기 추출물이 든 라면 스프)까지 반입 금지·압수 대상입니다. 생과일·씨앗·육류는 반드시 세관 신고서에 자진 신고해야 하며, 미신고 시 최소 $300 과태료가 부과됩니다.",
      "banned": [
  ...
  },
  {
    ...
    "customs": {
      "warning": "전자담배·베이프·가열담배(IQOS 등)는 기기·액상·부품 모두 반입·소지·사용이 전면 금지입니다. 소지만으로도 최대 징역 10년 또는 물품 가액 5배 벌금 및 압수 대상이니 절대 가져가지 마세요.",
      "banned": [
  ...
  },
  {
    ...
    "customs": {
      "warning": "전자담배·베이프는 반입 금지 품목으로 세관에서 압수·벌금 대상입니다. 드론·전문 촬영장비는 국방부 사전 허가가 없으면 공항에서 압수되고 보관료가 발생합니다.",
      "banned": [
        "전자담배·베이프 및 액상",
        "마약류·폭발물·무기·군용물자",
        "상아·코뿔소 뿔 등 멸종위기종 제품",
  ...
  },
  {
    ...
    "customs": {
      "warning": "가품(짝퉁 명품) 휴대 입국은 적발 시 압수는 물론 정품가 기준의 고액 벌금이 부과됩니다. EU 역외(한국 등)산 육류·유제품은 소량이라도 반입이 금지됩니다.",
      "banned": [
  ...
  },
  {
    ...
    "continent": "europe",
    "flag": "🇮🇹",
    "image": "https://images.unsplash.com/photo-1516483638261-f40889d0733a?q=80&w=800&auto=format&fit=crop",
    "visa": {
      "status": "무비자",
    ...
    "customs": {
      "warning": "EU 역외(한국 등)산 육류·유제품(살라미·치즈 등)은 반입이 금지됩니다. 가품(짝퉁) 소지는 범죄로 수백~수천 유로의 벌금 대상이며, 문화재·유물 반출도 엄격히 통제됩니다.",
      "banned": [
        "EU 역외산 육류·유제품",
        "위조·복제(짝퉁) 물품",
        "마약류",
  ...
  },
  {
    ...
    "customs": {
      "warning": "현지화 50,000페소 초과 또는 미화 US$10,000 상당액 초과 현금은 반드시 세관에 신고해야 하며, 미신고 시 압수 대상입니다. 총기·폭발물·마약은 엄격히 금지됩니다.",
      "banned": [
        "총기·탄약·폭발물·전쟁무기",
        "마약류 및 향정신성 물질",
        "낙태 유발 약품·기구",
  ...
  },
  {
    ...
    "visa": {
      "status": "전자여행허가 (ETA)",
      "duration": "최대 90일 체류 가능",
      "requirements": "출발 전 전용 모바일 앱 'AustralianETA'를 스마트폰에 다운로드하여 본인이 직접 여권 스캔 후 승인 필수 (수수료 AUD 20)",
    ...
    "customs": {
      "warning": "세계 최고 강도의 검역(Biosecurity)이 적용됩니다. 꿀·육포·생과일·목공예품은 물론 먹던 간식·초콜릿 한 조각까지 입국카드에 반드시 '자진 신고'해야 하며, 미신고 시 최대 AUD 2,664 과태료 또는 비자 취소 대상입니다.",
      "banned": [
