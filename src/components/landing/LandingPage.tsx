...
export function LandingPage({ onEnter }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden px-5 lg:px-10 pt-16 pb-20 lg:pt-28 lg:pb-28 bg-gradient-to-b from-brand-50/70 via-white to-white">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <div className="mt-14 flex flex-col items-center gap-1 text-slate-300">
      ...
      {/* Pain points */}
      <section className="px-5 lg:px-10 py-16 lg:py-24 bg-slate-50/70">
          ...
          <SectionTitle
            ...
            title={
              <>
                여행 준비, 정보가 없어서가 아니라
                <br />
                <span className="text-slate-400">흩어져 있어서 힘들었어요.</span>
              </>
            }
          />
            ...
            {FEATURES.map((f, idx) => (
              ...
              >
                <div className="w-14 h-14 shrink-0 rounded-2xl bg-brand-50 text-brand-600 flex items-center justify-center">
                  <i className={`ph ph-${f.icon} text-3xl`} />
                </div>
                <div>
      ...
      {/* Trust */}
      <section className="px-5 lg:px-10 py-16 lg:py-24 bg-gradient-to-b from-white to-brand-50/50">
      ...
      {/* Final CTA */}
      <section className="px-5 lg:px-10 py-20 lg:py-28 bg-slate-900 text-center">
